...
public class PlayerBowlingState : MonoBehaviourPunCallbacks, PlayerState
{
    ...
    IEnumerator WaitGrounded()
    {
        ...
        //playercontroller.startPush = false;
        ...
        playercontroller.startTorque = true;

        playercontroller._ball.GetComponent<ball>().OnStartSpin(true,playercontroller.spinvalue);
        // rig.AddTorque(transform.right * playercontroller.spinvalue * playercontroller.spinScaler, ForceMode.Impulse);
